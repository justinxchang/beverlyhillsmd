...
<head>
    ...
    <link href="./images/GothamBook.otf" rel='stylesheet' type='text/css'>
    <link href="./images/GothamMedium.otf" rel='stylesheet' type='text/css'>
...
<body class="body ">
    ...
    <div class="bullets">
        ...
        <ul class="bullets_ul">
            ...
            <li class="bullets_li">Breakthrough Study on Exceptional<br> Skin Agers</li>
            <li class="bullets_li">How To Become an Exceptional<br> Skin Ager</li>
        </ul>
    </div>
    <div >
        <h1 class="caption">BEVERLY HILLS MD ADVANCED DERMAL RENEWAL</h1>        
    </div>
    <div class="natural">
    ...
    <div class="benefits">
        <div class="benefits_points">
            ...
            <p class="benefits_text">Targets internal problems that cause visible aging</p>
        </div>
        <div class="benefits_points">
            <img class="benefits_image" src="./images/img 2@3x.png">
            <p class="benefits_text">Reduces the appearance of sagging or drooping</p>
        </div>
        <div class="benefits_points">
            <img class="benefits_image" src="./images/img 3@3x.png">
            <p class="benefits_text">Diminishes the appearance of wrinkles and dullness</p>
        </div>
        <div class="benefits_points">
            <img class="benefits_image" src="./images/img 4@3x.png">
